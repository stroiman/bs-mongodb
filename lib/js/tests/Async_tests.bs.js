...
var TestContext     = require("re-respect/lib/js/src/TestContext.js");
...
Curry._1(Respect.Dsl[/* Async */12][/* register */3], Curry._2(Respect.Dsl[/* Async */12][/* describe */2], "Mongo", /* :: */[
          Curry._2(Respect.Dsl[/* Async */12][/* describe */2], "An object has already been inserted", /* :: */[
                Curry._1(Respect.Dsl[/* Async */12][/* beforeEach */4], (function (ctx, don) {
                        return Async.run(/* None */0, (function (id) {
                                      TestContext.add("id", id, ctx);
                ...
                /* :: */[
                  Curry._2(Respect.Dsl[/* Async */12][/* it */1], "is retrievable", (function (ctx) {
                          var id = TestContext.get("id", ctx);
